...
namespace SMI
{
    ...
    public class SMI_Example_DrawGazePosition : MonoBehaviour
    {
        ...
        private GameObject gazeVis = null;
        private Vector3 initialeScale = Vector3.zero;
        ...
        private void UpdateThePosition()
        {
            ...
            if (hitInformation.collider != null)
            {
                ...
                gazeVis.transform.localRotation = SMIEyeTrackingUnity.Instance.transform.rotation;
            ...
            else
            {
                ...
                gazeVis.transform.rotation = SMI.SMIEyeTrackingUnity.Instance.transform.rotation;
