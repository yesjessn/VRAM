...
public class AnimationEthan : MonoBehaviour {
	...
	void Update () {
		if (!childAnimator.IsInTransition(0) && childAnimator.GetCurrentAnimatorStateInfo (0).normalizedTime >= 3.33) { //Average animation is 9s -> every 3.3 loops change for about 30s
